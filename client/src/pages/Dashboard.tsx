...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen p-6 max-w-5xl mx-auto space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {sections.news && (
          <div className="bg-white rounded-2xl shadow p-5 space-y-2">
            ...
            <div className="text-sm opacity-70">source: {sections.news.source}</div>
        ...
        {sections.aiInsight && (
          <div className="bg-white rounded-2xl shadow p-5 space-y-2">
            ...
            <div className="text-sm opacity-70">source: {sections.aiInsight.source}</div>
        ...
        {sections.meme && (
          <div className="bg-white rounded-2xl shadow p-5 space-y-2">
            ...
            {sections.meme.url ? (
              <img src={sections.meme.url} className="rounded-xl max-h-72 object-contain" />
            ) : (
      ...
      {!sections.news && !sections.prices && !sections.aiInsight && !sections.meme && (
        <div className="p-6 bg-white rounded-2xl shadow">No sections selected in preferences.</div>
      )}
    </div>
  );
}
